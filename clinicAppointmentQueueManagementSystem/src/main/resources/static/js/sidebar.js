...
(function () {
    ...
    window.buildSidebar = function () {
        ...
        // clear existing links (keep logo-area)
        ...
        logout.href = '#';
        logout.setAttribute('onclick', 'logout ? logout() : (localStorage.clear(), window.location.href="login.html"); return false;');
